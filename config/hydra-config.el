...
(defhydra hydra-org-roam (:color teal :quit t)
  ...
  ("n" org-roam-dailies-find-tomorrow "daily-tomorrow")
  ("p" org-roam-dailies-find-yesterday "daily-yesterday")
  ("N" org-roam-dailies-find-next-note "daily-next")
  ("P" org-roam-dailies-find-previous-note "daily-prev")
  ("l" org-roam-node-insert "insert-roam-link")
  ("L" org-store-link "store-link")
  ("M-l" org-insert-link "insert-org-link")
  ("o" org-open-at-point-global "org-open")
  ("b" org-roam-buffer-toggle "roam-buffer")
  ("B" org-roam-buffer-display-dedicated "roam-buffer-dedicated")
